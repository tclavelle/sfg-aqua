...
m2_vars <- c('province_name','aqua_harvest','aqua_value', 'all_value','area_population')  
...
m3_vars <- c('province_name','aqua_harvest','aqua_value', 'all_value','area_population')  
fmla_3 <- as.formula(paste("log(comm_catch) ~ ", paste( m3_vars, collapse= "+"))) 
m3 <- glm(fmla_3, family = gaussian(link = 'log'), data = phils_reg)

# Model 4 - regressing all catch
m4_vars <- c('province_name','aqua_harvest','aqua_value', 'all_value','area_population')  
fmla_4 <- as.formula(paste("log(all_catch) ~ ", paste( m4_vars, collapse= "+"))) 
m4 <- glm(fmla_4, family = gaussian(link = 'log'), data = phils_reg)
